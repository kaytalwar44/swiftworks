...
export type JobStatus =
  | 'draft' | 'scheduled' | 'published' | 'in_progress'
...
export type BookingError =
  | 'invalid_token' | 'qr_inactive' | 'qr_expired' | 'job_not_found'
  | 'job_not_published' | 'job_closed' | 'job_cancelled' | 'slot_not_found'
  | 'slot_unavailable' | 'slot_full' | 'unit_already_booked'
  | 'verification_required' | 'verification_invalid'
...
export interface UserRow {
  ...
  timezone: string;
  locale: string;
  notification_prefs: { email: boolean; sms: boolean; push: boolean; in_app: boolean };
...
// =============================================================================
// DATABASE — consumed by createClient<Database>() in client.ts
// =============================================================================
...
export interface Database {
  public: {
    ...
    Functions: {
      // Phase 5 — public RPCs. Args and returns are loosely typed here;
      // regenerate with the CLI for exact signatures.
      create_booking: { Args: Record<string, unknown>; Returns: unknown };
      cancel_booking: { Args: Record<string, unknown>; Returns: unknown };
      reschedule_booking: { Args: Record<string, unknown>; Returns: unknown };
      booking_lookup: { Args: { p_token: string }; Returns: unknown };
      available_slots: { Args: { p_token: string }; Returns: unknown };
      create_job: { Args: Record<string, unknown>; Returns: string };
      generate_slots: { Args: { p_job_id: string }; Returns: number };
      publish_job: { Args: Record<string, unknown>; Returns: unknown };
      assign_technician: { Args: Record<string, unknown>; Returns: string };
      complete_job: { Args: { p_job_id: string }; Returns: unknown };
      create_customer: { Args: Record<string, unknown>; Returns: string };
      search_customers: { Args: Record<string, unknown>; Returns: unknown };
      create_invoice: { Args: Record<string, unknown>; Returns: string };
      add_invoice_item: { Args: Record<string, unknown>; Returns: string };
      build_pay_run: { Args: Record<string, unknown>; Returns: unknown };
      finalize_invoice: { Args: { p_invoice_id: string }; Returns: unknown };
      dashboard_summary: { Args: Record<string, unknown>; Returns: unknown };
      partner_dashboard: { Args: Record<string, unknown>; Returns: unknown };
      technician_dashboard: { Args: Record<string, unknown>; Returns: unknown };
      notification_metrics: { Args: Record<string, unknown>; Returns: unknown };
      // Phase 3 — auth
      create_tenant: { Args: Record<string, unknown>; Returns: string };
      handle_new_user: { Args: Record<string, unknown>; Returns: string };
      invite_user: { Args: Record<string, unknown>; Returns: unknown };
      revoke_invitation: { Args: { p_invitation_id: string }; Returns: boolean };
      invitation_lookup: { Args: { p_token: string }; Returns: unknown };
      accept_invitation: { Args: { p_token: string }; Returns: string };
      complete_onboarding: { Args: Record<string, unknown>; Returns: boolean };
      // Phase 6 — notifications
      queue_email: { Args: Record<string, unknown>; Returns: string };
      queue_sms: { Args: Record<string, unknown>; Returns: string };
      queue_push: { Args: Record<string, unknown>; Returns: string };
      process_notifications: { Args: Record<string, unknown>; Returns: unknown };
      complete_notification: { Args: Record<string, unknown>; Returns: unknown };
      retry_failed_notifications: { Args: Record<string, unknown>; Returns: number };
      schedule_booking_reminders: { Args: Record<string, unknown>; Returns: unknown };
      schedule_technician_run_sheets: { Args: Record<string, unknown>; Returns: unknown };
      expire_notifications: { Args: Record<string, unknown>; Returns: unknown };
      booking_housekeeping: { Args: Record<string, never>; Returns: unknown };
    };
    Enums: {
...
export interface DashboardSummary {
  ...
  jobs: { total: number; published: number; in_progress: number; completed: number };
  bookings: {
    total: number; today: number; confirmed: number; completed: number; no_show: number;
  };
  slots: { open: number; capacity: number };
  qr: { active: number; scans: number; conversion_rate: number };
  invoices: { draft: number; payable_outstanding: number; receivable_outstanding: number };
...
export interface PartnerDashboard {
  partner_id: string | null;
  period: { from: string; to: string };
  jobs: { total: number; published: number; active: number };
  bookings: { total: number; today: number; completed: number };
  capacity: { open_slots: number; remaining: number };
  units: { contracted: number; booked: number };
  progress_pct: number;
}
...
export interface TechnicianDashboard {
  ...
  week: { total: number; completed: number };
  earnings: {
    current_period: {
      invoice_id: string;
      invoice_number: string;
...
export interface NotificationMetrics {
  ...
  company_id: string | null;
  totals: {
    queued: number; processing: number; sent: number;
    failed: number; dead_letter: number; cancelled: number; delivered: number;
  };
  by_channel: Record<string, {
    total: number; sent: number; failed: number; dead_letter: number; success_rate: number;
  }>;
  top_failures: Array<{ code: string; channel: string; count: number }>;
  retry_pressure: { attempt_1: number; attempt_2: number; attempt_3_plus: number };
